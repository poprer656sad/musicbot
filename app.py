...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        MainWindow.setFixedSize(1350, 600)
        MainWindow.setStyleSheet("background-color: #1E1E1E;")
        MainWindow.setWindowTitle("Musicbot")
    ...
    def create_task(self):
        ...
        category = self.createdialog.category_box.currentText()
        ...
        style = self.createdialog.style_edit.text()
        size = self.createdialog.size_box.currentText()
